                  ...
                  <form action="proses/proses_editsuratmasuk.php" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        ...
                        <select value="<?php echo $data['kategori']; ?>" id="kategori" name="kategori" class="select2_single form-control" tabindex="-1" >
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <div class='input-group date' id='myDatepicker4'>
                            <input type='text' id="tanggalmasuk_suratmasuk" name="tanggalmasuk_suratmasuk" required="required" class="form-control" aria-describedby="inputSuccess2Status3" required="required" readonly="readonly" />
